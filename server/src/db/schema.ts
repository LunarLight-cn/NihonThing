...
export const Ships = sqliteTable("Ships", {
  ...
  max_cap: text("max_cap"),
  current_cap: text("current_cap"),
...
export const Products = sqliteTable("Products", {
  ...
  desc: text("desc"),
  brand: text("brand"),
  price_tentative: real("price_tentative"),
  img: text("img"),
  tag: text("tag"),
...
export const Orders = sqliteTable("Orders", {
  ...
  payment_status: text("payment_status", { enum: ["pending_deposit", "deposit_paid", "pending_full", "fully_paid"] }),
...
export const Payments = sqliteTable("Payments", {
  ...
  payment_type: text("payment_type", { enum: ["deposit", "remaining", "shipping", "full"] }).notNull(),
  method: text("method"),
